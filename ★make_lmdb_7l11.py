...
if __name__ == '__main__':
    # 파일 경로 설정
    ligand_dir = 'data/docked_ligands_7l11whole_qvina'
    protein_pdb_file = 'data/mpro_complex/pocket/7l11_A_pocket.pdb'
    lmdb_path = 'data/output_ligand_protein_7l11_pocket10.lmdb'
    csv_file = 'data/docked_ligands_7l11whole_qvina/cov2_IC50_all_with_NewGenID.csv'
    ...
    for ligand_file in os.listdir(ligand_dir):
        if ligand_file.endswith('.pdbqt'):
            ...
            try:
                ...
                ligand_index_str = os.path.basename(ligand_pdbqt_path).split('_')[1]
